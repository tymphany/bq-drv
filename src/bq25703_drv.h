...
#define CHARGE_CURRENT_LEVEL_3              CHARGE_CURRENT_1856mA
...
#define INPUT_VOLTAGE_LIMIT_4V1   0x03C0 //4800mV
...
#define BATTERY_DISCHARGE_STOP_TEMPERATURE_HIGH_THRESHOLD           (65)
